...
- **玩法**：回合制战斗 + 角色养成 + 副本探索 + 社交系统
- **平台**：Web端即开即玩，PC/手机双端自适应
- **特色**：无随从系统，纯职业build玩法，还原经典副本动态难度

## 📋 核心设计文档
| 文档 | 状态 |
|------|------|
| [核心玩法设计](docs/gameplay.md) | 📝 待写 |
| [职业技能天赋设计](docs/classes.md) | 📝 待写 |
| [副本与大地图设计](docs/world.md) | 📝 待写 |
| [社交系统设计](docs/social.md) | 📝 待写 |
| [技术架构设计](docs/architecture.md) | 📝 待写 |
| [开发 roadmap](docs/roadmap.md) | 📝 待写 |
